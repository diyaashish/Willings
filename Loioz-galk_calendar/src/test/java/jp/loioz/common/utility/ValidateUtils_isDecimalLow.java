...
@Transactional
public class ValidateUtils_isDecimalLow {
	...
	public void case1() throws Exception {
		...
		assertEquals(false, ValidateUtils.isDecimalLow(source, target));
	}
	...
	public void case3() throws Exception {
		...
		assertEquals(true, ValidateUtils.isDecimalLow(source, target));
	}
