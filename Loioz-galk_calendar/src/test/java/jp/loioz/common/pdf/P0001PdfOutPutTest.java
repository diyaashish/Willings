...
@SpringBootTest
public class P0001PdfOutPutTest {
	...
	/** builderクラス */
	private P0001PdfBuilder builder;
	...
	public void testMakePdfFile() throws Exception {
		...
		P0001Data testData = this.createTestData();
	 ...
	 * @return
	 */
	private P0001Data createTestData() throws Exception {
...
//		testData.setStamp(getTestStamp());
		...
		testData.setHideAzukariDate(true);
