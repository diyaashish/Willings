 ...
 */
@Data
public class AdvisorMeiboListExcelDto {

	/** 名簿一覧：顧問 */
	List<ExcelAdvisorMeiboListRowData> advisorMeiboListDtoList = Collections.emptyList();

	/**
	 * 名簿一覧：顧問の1行分のデータ
	 */
	@Data
	public static class ExcelAdvisorMeiboListRowData {
