 ...
 */
@Setter
public class Cn0007CsvBuilder extends AbstractMakeCsvBuilder<CsvBuilderDto> {
	...
	public CsvRowDto getHeaderRowDto() {
		...
		itemList.add(new CsvRowItemDto("事務所名"));
	...
	public void makeCsvFile(HttpServletResponse response) throws IOException, Exception {
		super.makeCsvFile(OutputCsvTemplate.CSV_NAIBU_7, this.csvBuilderDto, response);
	}
