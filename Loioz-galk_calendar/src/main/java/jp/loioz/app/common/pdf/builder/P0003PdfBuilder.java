...
/**
 * 実費明細書PDF出力のBuilderクラス
 */
@Setter
public class P0003PdfBuilder extends AbstractMakePdfBuilder<P0003Data> {

	/**
	 * 実費明細書PDFを作成し、HttpResponseに書き込みを行う
	 * 
	 * @param response
	 * @throws IOException
	 * @throws Exception
	...
	public void makePdfFile(HttpServletResponse response) throws IOException, Exception {
		super.makePdfFile(OutputPdfTemplate.PDF_3, response);
	}

	/**
	 * 実費明細書PDFを作成し、バイトデータを返却する
	 *
	 * @return
	 * @throws IOException
	 * @throws Exception
	...
	public FileContentsDto makePdfContentsDto() throws IOException, Exception {
		return super.makePdfContentsDto(OutputPdfTemplate.PDF_3);
	}
	...
	public void makePdfFileTest() throws IOException, Exception {
		super.makePdfFileTest(OutputPdfTemplate.PDF_3);
	}
