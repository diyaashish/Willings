 ...
 */
@Setter
public class Cn0014CsvBuilder extends AbstractMakeCsvBuilder<CsvBuilderDto> {

	/** ファイル名 */
	public static final String FILE_NAME = "筆まめ_顧客名簿";
	...
	public void makeCsvFile(HttpServletResponse response) throws IOException, Exception {
		super.makeCsvFile(OutputCsvTemplate.CSV_NAIBU_14, this.csvBuilderDto, response);
	}
