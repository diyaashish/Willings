 ...
 */
@Setter
public class Cn0015CsvBuilder extends AbstractMakeCsvBuilder<CsvBuilderDto> {

	/** ファイル名 */
	public static final String FILE_NAME = "筆まめ_顧問取引先";
	...
	public void makeCsvFile(HttpServletResponse response) throws IOException, Exception {
		super.makeCsvFile(OutputCsvTemplate.CSV_NAIBU_15, this.csvBuilderDto, response);
	}
