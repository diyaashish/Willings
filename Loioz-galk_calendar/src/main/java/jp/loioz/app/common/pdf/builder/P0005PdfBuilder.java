...
/**
 * 支払計画書PDF出力のBuilderクラス
 */
@Setter
public class P0005PdfBuilder extends AbstractMakePdfBuilder<P0005Data> {

	/**
	 * 支払計画書PDFを作成し、HttpResponseに書き込みを行う
	 * 
	 * @param response
	 * @throws IOException
	 * @throws Exception
	...
	public void makePdfFile(HttpServletResponse response) throws IOException, Exception {
		super.makePdfFile(OutputPdfTemplate.PDF_5, response);
	}

	/**
	 * 支払計画書PDFを作成し、バイトデータを返却する
	 *
	 * @return
	 * @throws IOException
	 * @throws Exception
	...
	public FileContentsDto makePdfContentsDto() throws IOException, Exception {
		return super.makePdfContentsDto(OutputPdfTemplate.PDF_5);
	}
	...
	public void makePdfFileTest() throws IOException, Exception {
		super.makePdfFileTest(OutputPdfTemplate.PDF_5);
	}
