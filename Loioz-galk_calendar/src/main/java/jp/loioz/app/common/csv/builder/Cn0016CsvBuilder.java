 ...
 */
@Setter
public class Cn0016CsvBuilder extends AbstractMakeCsvBuilder<CsvBuilderDto> {
	...
	public CsvRowDto getHeaderRowDto() {
		...
		itemList.add(new CsvRowItemDto("報酬(税込)"));
		itemList.add(new CsvRowItemDto("未請求"));
	...
	public void makeCsvFile(HttpServletResponse response) throws IOException, Exception {
		super.makeCsvFile(OutputCsvTemplate.CSV_NAIBU_16, this.csvBuilderDto, response);
	}
