 ...
 */
@AllArgsConstructor
public enum Wn0005WordEnum implements WordEnum {

	TXT_ID(ChohyoWordConstant.TXT_id, CommonConstant.BLANK),
	TXT_ZIPCODE(ChohyoWordConstant.TXT_ZIPCODE, CommonConstant.BLANK),
	TXT_ADDRESS1(ChohyoWordConstant.TXT_ADDRESS1, CommonConstant.BLANK),
	TXT_ADDRESS2(ChohyoWordConstant.TXT_ADDRESS2, CommonConstant.BLANK),
	...
	@AllArgsConstructor
	class Wn0005WordEnumDto implements WordEnum {
	...
	public WordEnum setValue(String value) {
		...
		return new Wn0005WordEnumDto(this.key, dtoValue);
	}
