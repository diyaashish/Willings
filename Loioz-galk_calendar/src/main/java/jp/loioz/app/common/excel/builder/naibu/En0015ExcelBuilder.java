 ...
 */
@Setter
public class En0015ExcelBuilder extends AbstractMakeExcelBuilder<MinjiSaibanListExcelDto> {

	/** 民事裁判のデータを入れる開始位置(Row) */
	...
	/** タイトル名 */
	public static final String TITLE_NAME = "民事裁判";
	...
	private enum TableContent {
		...
		SAIBAN_START_DATE(20, "申立日／起訴日"),
		SAIBAN_END_DATE(21, "完了日／判決日"),
		;
	 ...
	 * Builder用DTO
	 */
	private MinjiSaibanListExcelDto saibanListExcelDto;

	/**
	 * {@inheritDoc}
	 */
	@Override
	public MinjiSaibanListExcelDto createNewTargetBuilderDto() {
		return new MinjiSaibanListExcelDto();
	}
	...
	public void makeExcelFile(HttpServletResponse response) throws IOException, Exception {
		super.makeExcelFile(OutputExcelTemplate.EXCEL_NAIBU_15, response);
	}
	...
	private void makeBody(XSSFWorkbook book, Sheet sheet) throws IOException {
		...
		// 裁判一覧データ取得
		List<ExcelMinjiSaibanListRowData> excelSaibanDataList = saibanListExcelDto.getSaibanListDtoList();
		...
		for (ExcelMinjiSaibanListRowData rowData : excelSaibanDataList) {
