 ...
 */
@Setter
public class Cn0012CsvBuilder extends AbstractMakeCsvBuilder<CsvBuilderDto> {

	/** ファイル名 */
	public static final String FILE_NAME = "筆まめ_顧客名簿（企業・団体）";
	...
	public void makeCsvFile(HttpServletResponse response) throws IOException, Exception {
		super.makeCsvFile(OutputCsvTemplate.CSV_NAIBU_12, this.csvBuilderDto, response);
	}
