 ...
 * Googleフォルダ
 */
@Entity(listener = TFolderGoogleEntityListener.class)
@Table(name = "t_folder_google")
public class TFolderGoogleEntity extends DefaultEntity {

    /** フォルダGoogle連番 */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "folder_google_seq")
    Long folderGoogleSeq;
    ...
    /** 
     * Returns the folderGoogleSeq.
     * 
     * @return the folderGoogleSeq
     */
    public Long getFolderGoogleSeq() {
        return folderGoogleSeq;
    }

    /** 
     * Sets the folderGoogleSeq.
     * 
     * @param folderGoogleSeq the folderGoogleSeq
     */
    public void setFolderGoogleSeq(Long folderGoogleSeq) {
        this.folderGoogleSeq = folderGoogleSeq;
    }
