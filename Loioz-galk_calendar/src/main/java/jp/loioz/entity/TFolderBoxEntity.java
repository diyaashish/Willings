 ...
 * Boxフォルダ
 */
@Entity(listener = TFolderBoxEntityListener.class)
@Table(name = "t_folder_box")
public class TFolderBoxEntity extends DefaultEntity {

    /** フォルダBox連番 */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "folder_box_seq")
    Long folderBoxSeq;

    /** ルートフォルダBox連番 */
    @Column(name = "root_folder_box_seq")
    Long rootFolderBoxSeq;
    ...
    /** 
     * Returns the folderBoxSeq.
     * 
     * @return the folderBoxSeq
     */
    public Long getFolderBoxSeq() {
        return folderBoxSeq;
    }

    /** 
     * Sets the folderBoxSeq.
     * 
     * @param folderBoxSeq the folderBoxSeq
     */
    public void setFolderBoxSeq(Long folderBoxSeq) {
        this.folderBoxSeq = folderBoxSeq;
    }

    /** 
     * Returns the rootFolderBoxSeq.
     * 
     * @return the rootFolderBoxSeq
     */
    public Long getRootFolderBoxSeq() {
        return rootFolderBoxSeq;
    }

    /** 
     * Sets the rootFolderBoxSeq.
     * 
     * @param rootFolderBoxSeq the rootFolderBoxSeq
     */
    public void setRootFolderBoxSeq(Long rootFolderBoxSeq) {
        this.rootFolderBoxSeq = rootFolderBoxSeq;
    }
