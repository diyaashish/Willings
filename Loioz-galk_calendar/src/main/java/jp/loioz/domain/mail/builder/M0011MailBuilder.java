...
/**
 * 【登録者宛】アカウント登録完了メールBuilder
 *
 */
@Component
public class M0011MailBuilder extends AbstractMailBuilder {
	...
	public void makeBody(String... args) {
		// 置換文字が4つ
		this.workBody = java.text.MessageFormat.format(this.workBody, args[0], args[1], args[2], args[3], args[4]);
	}
