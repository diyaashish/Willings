 ...
 */
@Component
public class M0007MailBuilder extends AbstractMailBuilder {
	...
	public void makeBody(String... args) {
		// 置換文字が8個
		this.workBody = java.text.MessageFormat.format(this.workBody, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
	}
}