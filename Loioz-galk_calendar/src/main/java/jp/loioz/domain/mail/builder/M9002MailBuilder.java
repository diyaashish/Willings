...
/**
 * 有料プラン申し込み完了通知メールBuilder
 *
 */
@Component
public class M9002MailBuilder extends AbstractMailBuilder {
	...
	public void makeBody(String... args) {
		// 置換文字が5個
		this.workBody = java.text.MessageFormat.format(this.workBody, args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
	}
}