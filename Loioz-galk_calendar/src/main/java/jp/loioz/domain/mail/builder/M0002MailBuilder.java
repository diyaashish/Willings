 ...
 */
@Component
public class M0002MailBuilder extends AbstractMailBuilder {
	...
	public void makeBody(String... args) {
		// 置換文字が2つ
		this.workBody = java.text.MessageFormat.format(this.workBody, args[0], args[1], args[2], args[3], args[4], args[5]);
	}
