...
/**
 * 問い合わせ解決済み通知メールBuilder
 */
@Component
public class M9006MailBuilder extends AbstractMailBuilder {
	...
	public void makeBody(String... args) {
		// 置換文字が?個
		this.workBody = java.text.MessageFormat.format(this.workBody, args[0], args[1], args[2]);
	}
}