...
where
  ...
  and tfcm.file_kubun = /* @jp.loioz.common.constant.CommonConstant$FileKubun@IS_FOLDER.getCd() */'0'
  and tfpim.view_limit = /* @jp.loioz.common.constant.CommonConstant$ViewLimit@VIEWING_LIMITED.getCd() */'1'
