...
ORDER BY
  ...
  /*%if sortConditions.sortItem == @jp.loioz.common.constant.meiboList.MeiboListConstant$CustomerAllMeiboListSortItem@PERSON_ID */
  -- 名簿IDでのソート
  , tc.person_id /*%if sortConditions.isDesc() */ DESC /*%end */
  /*%end */
  
  /*%if sortConditions.sortItem == @jp.loioz.common.constant.meiboList.MeiboListConstant$CustomerAllMeiboListSortItem@NAME */
  -- 名前（かな）でのソート
  ...
  /*%if sortConditions.sortItem == @jp.loioz.common.constant.meiboList.MeiboListConstant$CustomerAllMeiboListSortItem@CUSTOMER_CREATE_DATE */
  -- 顧客作成日でのソート
