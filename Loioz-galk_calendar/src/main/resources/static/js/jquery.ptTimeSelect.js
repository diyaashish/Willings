...
//                        +    '                    <span class="ui-icon ui-icon-circle-close">X</span>'
                        ...
                        +    '                <span id="ptTimeSelectUserSelMin">30</span> '
                        ...
                        +    '                    <div class="ptTimeSelectLeftPane" style="width: 50%; text-align: center; float: left; font-size: 13px; margin: 5px 0;" class="">Hour</div>'
                        +    '                    <div class="ptTimeSelectRightPane" style="width: 50%; text-align: center; float: left; font-size: 13px; margin: 5px 0;">Minutes</div>'
                        +    '                </div>'
                        +    '                <div>'
                        +    '                    <div style="float: left; width: 55%; padding-left: 5px;">'
...
//                        +    '                            </div>'
                        ...
                        +    '                        </div>'
                        +    '                    </div>'
                        +    '                    <div style="float: right; width: 38%; padding-right: 5px;">'
                        ...
                        +    '            <div style="clear: left;"></div>'
	                        ...
	                        +    '                    onmouseover="jQuery(this).removeClass(\'ui-state-default\').addClass(\'ui-state-hover\');" '
	                        +    '                        onmouseout="jQuery(this).removeClass(\'ui-state-hover\').addClass(\'ui-state-default\');"'
	                        +    '                        class="ui-corner-all ui-state-default" style="font-weight: bold; margin: 0 5px 3px 0;">'
	                        +    '                SET'
	                        +    '            </a>'
